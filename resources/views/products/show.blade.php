        ...
        <div class="container mx-auto px-6">
            <div class="md:flex md:items-center">
                <div class="w-full h-full md:w-1/2 lg:h-full">
                    <img class="lg:h-[500px] rounded-md object-cover max-w-lg mx-auto" src="/storage/{{$product->image}}" alt="Nike Air">
                </div>
                <div class="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                    <h3 class="text-gray-900 uppercase text-2xl">{{$product->name}}</h3>
                    <span class="block text-gray-700 mt-3">Rs: {{$product->price}}</span>
                    <span class="block text-gray-700 mt-3">Items: {{$product->quantity}}</span>
                    <div class="mt-3">
                    ...
                    <form action="{{route('cart',$product)}}" method="post">
                        ...
                        <div class="mt-2">
                            ...
                            <div class="flex items-center mt-1">
                                ...
                                <input type="number" min="1" max="{{$product->quantity}}" id="quantity" class="bg-gray-100 border-2 w-3/12 p-2 rounded-lg @error('quantity') border-red-500 @enderror " name="quantity" required>
            ...
            <div class="pl-7 pr-8">
                <h2 class="text-4xl font-medium leading-tight mt-0 mb-2 text-violet-800">Product Description</h2>
